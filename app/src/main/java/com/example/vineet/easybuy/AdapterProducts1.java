...
public class AdapterProducts1 extends RecyclerView.Adapter<AdapterProducts1.MyViewHolder> {
    Context context;
   ...
   // SessionManager sessionManager = new SessionManager();
    public AdapterProducts1(Context context, List<String> namelist,List<String> pricelist,List<Drawable> imagelist) {
        ...
        holder.minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(holder.txt.getText().equals("1")){
                    ...
                    update(new_count,String.valueOf(position+1));
                    listdata1();
