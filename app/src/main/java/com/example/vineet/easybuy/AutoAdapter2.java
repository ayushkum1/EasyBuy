...
public class AutoAdapter2 extends RecyclerView.Adapter<AutoAdapter2.MyViewHolder> {
    Context context;
    ...
    public AutoAdapter2(Context context, List primarytextList, List secondarytextList) {
